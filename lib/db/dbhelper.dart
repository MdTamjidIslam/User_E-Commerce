...
class DbHelper {
  ...
  static Future<void> addToCart(CartModel cartModel, String uid) => _db
  ...
  // static Stream<QuerySnapshot<Map<String, dynamic>>> getAllProducts() =>
  //     _db.collection(collectionProduct).where(productAvailable,isNotEqualTo:true).snapshots();

  static Stream<QuerySnapshot<Map<String, dynamic>>> getCartByUsers(
          String uid) =>
      _db
          .collection(collectionUser)
          .doc(uid)
